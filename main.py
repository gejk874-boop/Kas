      ...
      if float(win_summ) >= 1.12:
        ...
        kb = None
          ...
          if check:
                ...
                kb = types.InlineKeyboardMarkup(row_width=1).row(types.InlineKeyboardButton('Написать админу', url='https://t.me/elite_moder'))
...
└ [<code>{message.from_user.id}</code>]</b>""")
    ...
    if check:
        ...
        btns = [
            ...
            types.InlineKeyboardButton(text="🎲 Сделать ставку", url='https://t.me/elite_casinoo'),
        ]
        kb.add(*btns)
...
<b>🗓 Вы с нами уже {days_joined_text}!</b>""", reply_markup=kb)
        ...
        try:
            await message.answer_photo(config.menu, f"""<b>💠 Для начала подпишитесь на канал:

<a href="https://t.me/elite_casinoo">🔗 Ссылка на канал</a></b>""", reply_markup=kb)
        except Exception as e:
...
<b>Общая сумма выплат игрокам:</b> <code>{formatted_wins}$</code> <b>[~ <code>{formatted_rub}₽</code>]</b>""", reply_markup=kb)
    ...
    if call.data == 'ref_panel':
        ...
        kb.add(*btns)
        kb.add(types.InlineKeyboardButton(text="Вывести накопления", url='https://t.me/elite_moder'))
...
<b>🔎 В случае проблем с зачислением средств обратитесь к @elite_moder (Владелец)</b>""", reply_markup=kb)
...
Выигрыш {win_amount}$ зачислен на ваш баланс. Кидай футбол и испытай свою удачу!</b></blockquote>\n\n<b><a href="https://t.me/EliteCasinoRules">Правила</a> | <a href="https://t.me/EliteCasinoNews">Новостной</a> | <a href="https://t.me/elite_moder">Поддержка</a> | <a href="https://t.me/Elite_Casinobot">Реферальный бот</a></b>""", reply_markup=kb)
                                    elif result == 'miss':
                                        kb = types.InlineKeyboardMarkup(row_width=1).row(types.InlineKeyboardButton('Сделать ставку', url=stavka_url))
...
Выигрыш {win_amount}$ зачислен на ваш баланс. Кидай дартс и испытай свою удачу!</b></blockquote>\n\n<b><a href="https://t.me/EliteCasinooRules">Правила</a> | <a href="https://t.me/EliteCasinooNews">Новостной</a> | <a href="https://t.me/elite_moder">Поддержка</a> | <a href="https://t.me/elite_casino_bot">Реферальный бот</a></b>""", reply_markup=kb)
                                        await contestss(amount, username)
                                        pass
                                    else:
                                        ...
                                        if user[4] is not None:
                                            ...
                                            await db.add_total_ref(user[4], percentage_amount)
                                        await bot.send_photo(config.channel_id, photo=config.lose, caption=f"""<blockquote><b>Проигрыш!</b>\n\n<b>Дротик прилетел на красное
Кидай дартс и испытай свою удачу!</b></blockquote>\n\n<b>Играй и зарабатывай вместе со мной в EliteCasino !\n▶<a href="https://t.me/elite_casinoo_bot?start=ref_{user_id}">ЗАРАБОТАТЬ</a>◀</b>\n\n\n<b><a href="https://t.me/EliteCasinooRules">Правила</a> | <a href="https://t.me/EliteCasinooNews">Новостной</a> | <a href="https://t.me/elite_moder">Поддержка</a> | <a href="https://t.me/elite_casinoo_bot">Реферальный бот</a></b>""", reply_markup=kb)
                                        await contestss(amount, username)
                                        pass
...
— Средства с комиссией 10% зачислены на ваш баланс!</b>\n\n👉 <a href="https://t.me/c/2110144414/5">Как сделать ставку?</a> | 👉 <a href="https://t.me/elite_casinoo_bot">Реф. программа</a>""", reply_markup=kb, disable_web_page_preview=True)
                            await contestss(amount, username)
                            if lose == True:
    ...
    if contests:
        for contest in contests:
            ...
            if amount > float(contest[3]):
                ...
                await bot.edit_message_caption(config.channel_id, contest[10], caption=f"""<b>[🎁] Ежедневный конкурс от <a href="https://t.me/elite_casinoo_bot">EliteCasino</a>!</b>
